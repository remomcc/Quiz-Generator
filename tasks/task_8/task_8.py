...
class QuizGenerator:
    ...
    def init_llm(self):
        ...
        self.llm = VertexAI(
            ...
            temperature = 0.4, # Increase for less deterministic questions 
    ...
    def generate_quiz(self) -> list:
        ...
        for _ in range(self.num_questions):
            ...
            while retry < retry_limit:
                ...
                clean_str = question_str.replace("`", "").replace("json", "")

                try:
                    # Convert the JSON String to a dictionary
                    question = json.loads(clean_str)
            ...
            if retry == retry_limit:
                print("Retry limit reached. Unable to generate unique question.")
