...
class ChromaCollectionCreator:
    ...
    def create_chroma_collection(self):
        ...
        print(len(self.processor.pages))
        ...
        if len(self.processor.pages) > 0:
            for page in self.processor.pages:
                ...
                text = text_splitter.create_documents([page_content])
                texts.extend(text)
        ...
        #Persist database instead of working in memory
            #Another way is to set "client" as new_client =  chromadb.PersistentClient(path = "embed_db")
